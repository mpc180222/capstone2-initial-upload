...
import paper_gradient from './paper_gradient.jpg';
...
function Review() {
    ...
    let INIT_STATE={title:'', description: '', body: '', rating:1, album_id:'', album_name:'', album_art:''};
    ...
    async function handleReviewSubmit(evt){
      ...
      let newReviewResp = await axios.put(`/reviews/${currReview.review.id}`, {title, description, body, rating});
