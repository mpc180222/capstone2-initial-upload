...
import featured_reviewer from './featured_reviewer.jpg';
...
function Prompt() {
    ...
    console.log(samplePopularReview)
    ...
    useEffect(() =>{
      ...
      async function getSampleData(){
        let res = await axios.get('/reviews/sample');
...
console.log(sampleLatestReview)
  ...
  return (
    <div className="home-container">
      <h1>Welcome to Reviewify</h1> 
        <h2>Browse our existing reviews, or search and write your own</h2>
